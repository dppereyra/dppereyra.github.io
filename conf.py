...
BLOG_AUTHOR = "Dennis Philippe Pereyra"  # (translatable)
BLOG_TITLE = "Chiff's Nook"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://personal.datachiff.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://personal.datachiff.com/"
BLOG_EMAIL = "dppereyra@gmail.com"
BLOG_DESCRIPTION = "Personal Site for Dennis Philippe Pereyra."  # (translatable)
